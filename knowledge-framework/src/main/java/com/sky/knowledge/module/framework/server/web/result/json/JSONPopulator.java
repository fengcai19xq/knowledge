...
import com.sky.knowledge.module.framework.server.web.result.json.annotation.DateFormat;
/**
*******************************************
...
public class JSONPopulator {
	...
	public static void populateObject(Object object, @SuppressWarnings("rawtypes") final Map elements)
	...
	public static Object convert(Class<?> clazz, Type type, Object value,
		...
		if (value == null) {
			...
			// leave it as null
			return clazz.isPrimitive() ? convertPrimitive(clazz, value, method)
					: null;
	...
	@SuppressWarnings("rawtypes")
	private static Object convertToArray(Class<?> clazz, Type type, Object value,
	...
	private static Object convertPrimitive(@SuppressWarnings("rawtypes") Class clazz, Object value,
		...
		if (value == null) {
			...
			if(Long.class.equals(value.getClass())){
				...
				if(String.class.equals(value.getClass())){
					...
					if(formate!=null){
						SimpleDateFormat sdf = new SimpleDateFormat(formate.formate());
						try {
							return sdf.parse((String) value);
						} catch (ParseException e) {
							LOG.debug(value+" Could not be parsed into Date type", e);
							throw new RuntimeException(e);
						}
					} else {
                        Locale locale = Locale.US;
                        SimpleDateFormat sdf = new SimpleDateFormat("EEE MMM dd yyyy HH:mm:ss", new DateFormatSymbols(locale));
                        try {
                            return sdf.parse((String)value);
                        } catch (ParseException e) {
                            LOG.debug(value+" Could not be parsed into Date type", e);
